...
def status_icon(status):
    ...
    """
    icons = {
        'CALLED': '<i class="fas fa-phone text-blue-500"></i>',
        'NOT_ANSWERED': '<i class="fas fa-phone-slash text-yellow-500"></i>',
        'INVALID_NUMBER': '<i class="fas fa-times-circle text-red-500"></i>',
